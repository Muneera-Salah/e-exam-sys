...
!(function (A) {
    ...
    149: function (A, e, t) {
        ...
        var n = t(51),
            ...
            h = (function () {
                ...
                return (
                    (A.prototype.startMoving = function (A, e) {
                    ...
                    (A.prototype.xmlSave = function (A) {
                        var e = this.prepData(A),
                            t = ["<form-template>\n\t<fields>"];
                        return (
                            s.default.forEach(e, function (A, e) {
                                var r = null,
                    ...
                    (A.prototype.prepData = function (A) {
                        ...
                        return (
                            0 !== A.childNodes.length &&
                                s.default.forEach(A.childNodes, function (A, o) {
                                    var i = $(o);
                    ...
                    (A.prototype.updatePreview = function (A) {
                        ...
                        if (-1 === r.indexOf("input-control")) {
                            ...
                            f && (c.style = f),
                                a.match(t.optionFieldsRegEx) &&
                                    ((c.values = []),
                                    (c.multiple = $('[name="multiple"]', o).is(":checked")),
                                    $(".sortable-options li", o).each(function (A, e) {
                                        var t = {};
                    ...
                    (A.prototype.dialog = function (A) {
                        ...
                        return (
                            e ? n.classList.add("positioned") : ((e = { pageX: _Mathmax(o, window.innerWidth || 0) / 2, pageY: _Mathmax(i, window.innerHeight || 0) / 2 }), (n.style.position = "fixed")),
                    ...
                    (A.prototype.removeAllFields = function (A) {
                        ...
                        if (
                            ...
                            a.some(function (A) {
                                return !0 === A;
                            }) || (A.parentElement.classList.add("empty"), (A.parentElement.dataset.content = r.getStarted)),
                            t)
                        ) {
                    ...
                    (A.prototype.orderFields = function (A) {
                        ...
                        return (
                            window.sessionStorage && (t.sortableControls ? (e = window.sessionStorage.getItem("fieldOrder")) : window.sessionStorage.removeItem("fieldOrder")),
                            e
                                ? ((e = window.JSON.parse(e)),
                                  (e = s.default.unique(e.concat(A))),
                    ...
                    (A.prototype.processOptions = function (A) {
                        ...
                        return (
                            (t = [
                                { type: "button", id: "clear", className: "clear-all btn btn-danger", events: { click: e.confirmRemoveAll.bind(e) } },
                                { type: "button", label: "viewJSON", id: "data", className: "btn btn-default get-data", events: { click: e.showData.bind(e) } },
                                {
                                    type: "button",
                                    id: "save",
                            ...
                            (i.disableFields = i.disableFields.concat(
                                r.map(function (A) {
                                    var e = A.type;
                                    return e && e;
                                })
                            )),
                            (d.config.opts = Object.assign({}, { actionButtons: t }, i)),
                            d.config.opts
                        );
                    }),
        ...
        var E = t(35),
            ...
            Q = function A(e, t) {
                ...
                function o(A, e) {
                    ...
                    return (
                        f.default.inArray(t.type, ["checkbox", "checkbox-group", "radio-group"]) || t.className.push("form-control"),
                        (t = Object.assign({}, e, t)),
                ...
                e.inputSets.length &&
                    e.inputSets.forEach(function (A, e) {
                        var t = A.name,
                            r = A.label,
                            o = A.icon;
                ...
                var _ = function () {
                        ...
                        return (
                            e.prepend && !$(".disabled-field.form-prepend", E.stage).length && (A.push(!0), N.prepend(t("prepend"))),
                    ...
                    AA = function (A) {
                        ...
                        if (A instanceof jQuery)
                            if (((t.type = A[0].dataset.type), t.type)) {
                                ...
                                e ||
                                    (t.values = A.children().map(function (A, e) {
                    ...
                    rA = function (A) {
                        var e = ["required", "label", "description", "placeholder", "className", "name", "access", "value"],
                            ...
                            o = {
                                autocomplete: e.concat(["grade","options"]),
                                button: ["label", "subtype", "style", "className", "name", "value", "access"],
                                checkbox: ["grade", "required", "label", "description", "toggle", "inline", "className", "name", "access", "other", "options"],
                                text: e.concat(["grade", "subtype", "maxlength"]),
                                date: e,
                                file: e.concat(["grade", "subtype", "multiple"]),
                                header: ["label", "subtype", "className", "access"],
                                hidden: ["name", "value", "access"],
                                paragraph: [ "label", "subtype", "className", "access"],
                                number: e.concat(["grade", "min", "max", "step"]),
                                select: e.concat(["grade", "multiple", "options"]),
                                textarea: e.concat(["grade", "subtype", "maxlength", "rows"]),
                            };
                    ...
                    nA = function (A) {
                        ...
                        return (
                            (e += C.input({ value: A || "default", type: "hidden", className: "btn-style" }).outerHTML),
                            ...
                            (e += "</div>"),
                            (e = D("div", [t, e], { className: "form-group style-wrap" })),
                            e.outerHTML
                        );
                    },
                    aA = function (A, e) {
                    ...
                    cA = function (A) {
                        var e = A.type,
                            ...
                            r = "";
                        return (
                            f.default.inArray(e, ["header", "paragraph", "button"]) && t.push(!0),
                            t.some(function (A) {
                                return !0 === A;
                    ...
                    uA = function (A) {
                        var t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1],
                            ...
                            n = [
                                D("a", null, { type: "remove", id: "del_" + h.lastID, className: "del-button btn icon-cancel delete-confirm", title: p.removeMessage }),
                                D("a", null, { type: "edit", id: h.lastID + "-edit", className: "toggle-form btn icon-pencil", title: p.hide }),
                                D("a", null, { type: "copy", id: h.lastID + "-copy", className: "copy-button btn icon-copy", title: p.copyButtonTooltip }),
                            ];
                        i &&
                            Array.isArray(i) &&
                        ...
                        var a = [
                                ...
                                D("span", " *", { className: "required-asterisk", style: A.required ? "display:inline" : "" }),
                            ],
                        ...
                        u.data("fieldData", { attrs: A }),
                            void 0 === C.stopIndex ? N.append(u) : $("> li", E.stage).eq(C.stopIndex).before(u),
                ...
                if (
                    (N.on("click touchstart", ".remove", function (A) {
                        ...
                        if (!A.target.classList.contains("other-option")) {
                            ...
                            if (f.default.inArray(t.type, ["select", "checkbox-group", "radio-group"])) {
                                ...
                                "select" === t.type
                                    ...
                                    : ((e = document.getElementsByName(A.target.name)),
                                      f.default.forEach(e, function (A) {
                    ...
                    eA(),
                    N.css("min-height", U.height()),
                    e.stickyControls.enable && C.stickyControls(N),
                ...
                return (
                    document.dispatchEvent(d.default.loaded),
                    (g.actions = {
        ...
        !(function (A) {
            A.fn.formBuilder = function (e) {
                ...
                var a = A.extend({}, B.defaultI18n, i, !0),
                    l = {
                        actions: { getData: null, setData: null, save: null, showData: null, setLang: null, addField: null, removeField: null, clearFields: null },
                        get formData() {
    ...
    19: function (A, e) {
        ...
        (window.fbLoaded = { js: [], css: [] }),
            ...
            (o.debounce = function (A) {
                var e,
                    t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 250,
                    r = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
                return function () {
                        ...
                        return (
                            ...
                            (A.prototype.get = function (A, e) {
                                var t,
                                    ...
                                    n = i.match(/\{[^\}]+?\}/g);
                                if (e && n)
                                    if ("object" === (void 0 === e ? "undefined" : o(e))) for (var a = 0; a < n.length; a++) (t = n[a].substring(1, n[a].length - 1)), (i = i.replace(r.makeSafe(n[a]), e[t] || ""));
            ...
            f = (function (A) {
                ...
                return (
                    ...
                    (e.prototype.build = function () {
                        ...
                        for (
                            var t = Object.assign(this.config), r = ["label", "description", "subtype", "id", "isPreview", "required", "title", "aria-required", "type"], o = r, i = Array.isArray(o), n = 0, o = i ? o : o[Symbol.iterator]();
                            ;
    ...
    52: function (A, e) {
        ...
        (e.defaultOptions = {
            ...
            (e.styles = { btn: ["default", "danger", "info", "primary", "success", "warning"] }),
            (e.defaultI18n = {
                ...
                return (
                    ...
                    (A.prototype.label = function () {
                        var A = this.data.label || "",
                            ...
                            t = [e];
                        return (
                            this.data.required && t.push(this.markup("span", "*", { className: "fb-required" })),
                            this.isTemplate("label") ? this.processTemplate("label", t) : this.markup("label", t, { for: this.data.id, className: "fb-" + this.data.type + "-label" })
                        );
                    }),
                                    ...
                                    callbacks: {
                                        onError: function (e, t, r) {
                                            ...
                                            var o = $("<div />")
                                                ...
                                                .html("<span>Error processing upload: <b>" + t + "</b>.<br />Reason: " + r + "</span>")
                                                .prependTo(A.find(".qq-uploader"));
                                            setTimeout(function () {
                                                o.fadeOut(function () {
                                                    o.remove();
                                                });
            ...
            c = (function (A) {
                ...
                return (
                    ...
                    (e.prototype.groupRequired = function () {
                        for (
                            var A = this.element.getElementsByTagName("input"),
                                e = function (A, e) {
            ...
            s = (function (A) {
                ...
                return (
                    ...
                    (e.prototype.onRender = function () {
                        ...
                        (t.instance = new window.Quill(this.field, { modules: { toolbar: [[{ header: [1, 2, !1] }], ["bold", "italic", "underline"], ["code-block"]] }, placeholder: this.config.placeholder || "", theme: "snow" })),
                            (t.data = new e()),
